// doing all things in console
// JS behaviour is prototypal
...
createUser.prototype.increment = function(){
    this.score++               // this means jisne bhi bulaya h uska kaam krdo
}
createUser.prototype.printMe = function(){
    console.log(`Score is ${this.score}`);
}

const chai = new createUser("chai", 25)      // without new it is showing error
const tea = new createUser("tea", 250)

chai.printMe()

// Here's what happens behinh the scene when the new keyword is used:
